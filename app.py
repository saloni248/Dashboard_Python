...
# Check if the 'Import' and 'Export' columns exist
if 'Import' not in data.columns or 'Export' not in data.columns:
    st.error("The dataset does not contain 'Import' or 'Export' columns.")
else:
    ...
    if 'Value' in filtered_data.columns and 'Customer' in filtered_data.columns:
        ...
        st.error("The dataset does not contain the necessary columns for customer-wise transactions.")
